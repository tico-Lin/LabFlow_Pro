...
const DEFAULT_MODULESVIEW_LAYOUT: Layout = [
  { i: "modules-overview", x: 0, y: 0, w: 12, h: 3, minW: 4, minH: 2 },
  { i: "modules-catalog",  x: 0, y: 3, w: 12, h: 9, minW: 4, minH: 5 }
];
  ...
  useEffect(() => {
    ...
    const loadModules = async () => {
      ...
      try {
        ...
        setAnalysisModules(parsePluginManifests(payload));
      } catch (error) {
        if (!isActive) {
          return;
        }
  ...
  return (
    <section className="page-shell modules-page">
      ...
      >
        ...
        <div key="modules-catalog" className="page-grid-item">
          <div className="grid-drag-handle" />
          <div className="page-grid-item-body">
            {isLoadingModules ? (
