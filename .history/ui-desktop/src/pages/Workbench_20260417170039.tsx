  ...
  return (
    <section className="page-shell workbench-page">
      ...
      <div className="workbench-content-grid">
        <section className="office-canvas-shell app-surface workbench-panel workbench-grid-panel">
          ...
          <div className="workbench-empty-notice-slot">
            {emptyNotice ? (
          ...
          <div className="workbench-grid-stage">
            <SpreadsheetGrid
        ...
        <section className="chart-shell app-surface workbench-panel workbench-chart-panel">
          ...
          <div className="workbench-chart-stage">
            <ScientificChart
              data={chartData}
