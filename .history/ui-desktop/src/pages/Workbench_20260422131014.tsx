...
export default function Workbench({
  ...
  useEffect(() => {
    ...
    const loadModules = async () => {
      ...
      try {
        ...
        const nextModules = parseAnalysisModules(payload);
        if (!isActive) {
          return;
        }
  ...
  const updateModuleField = (parameter: AnalysisModule["parameters"][number], value: string) => {
    ...
    <section className="page-shell workbench-page">
      ...
      <div className="workbench-content-grid">
        <div className="workbench-main-column">
          <section className="office-canvas-shell workbench-panel workbench-panel-flat">
