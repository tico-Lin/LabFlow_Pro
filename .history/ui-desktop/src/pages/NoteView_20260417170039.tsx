      ...
      <div className="page-hero app-surface">
        ...
        <div className="page-hero-actions">
          <button type="button" className="secondary-button" onClick={handleCreateNote}>
            <Plus aria-hidden={true} className="toolbar-control-icon" color="var(--text-primary)" />
        ...
        <aside className="notes-sidebar app-surface">
          ...
          {notes.length === 0 ? (
            <div className="notes-empty-state">
              <FilePenLine aria-hidden={true} color="var(--text-primary)" />
            ...
            <div className="notes-editor-stack">
              <div className="notes-editor-header">
                ...
                <button type="button" className="ghost-button" onClick={() => handleDeleteNote(activeNote.id)}>
                  <Trash2 aria-hidden={true} className="toolbar-control-icon" color="var(--text-primary)" />
              ...
              <div data-color-mode={colorMode} className="notes-markdown-shell">
                <MDEditor
