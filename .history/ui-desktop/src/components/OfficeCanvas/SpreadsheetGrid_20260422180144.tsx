...
export default function SpreadsheetGrid({
  ...
  }, [fillContainer, resizable, viewportHeight, viewportWidth]);
  ...
  return (
    <div
      ref={shellRef}
      className={`spreadsheet-grid-shell${resizable ? " is-resizable" : ""}${fillContainer ? " is-fill" : ""}${isResizing ? " is-resizing" : ""}`}
      style={resizable ? undefined : fillContainer ? { maxWidth: "100%", height: "100%" } : { maxWidth: viewportWidth }}
    >
      ...
      <div
        ...
        style={fillContainer ? undefined : { width: viewportSize.width, height: viewportSize.height }}
      >
        <div
