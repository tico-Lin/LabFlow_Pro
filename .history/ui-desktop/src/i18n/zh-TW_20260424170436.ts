const zhTW = {
  ...
  assetHub: {
    eyebrow: "Asset Hub",
    title: "資料總管",
    description: "集中管理工作區中的二進位資產，快速檢視檔案血緣與核心 metadata。",
    import: "匯入檔案",
    importing: "匯入中...",
    refresh: "重新整理",
    gridAriaLabel: "檔案卡片網格",
    emptyTitle: "目前還沒有匯入檔案",
    emptyDescription: "按下「匯入檔案」即可將原始檔案存入 Blob Storage 並同步到圖譜。",
    fileCard: {
      size: "大小",
      hash: "Hash",
      untitled: "未命名檔案",
    ...
    editModal: {
      ...
      tagsHint: "每輸入一個標籤後按 Enter 即可新增。",
      removeTag: "移除標籤",
      remarkLabel: "備註",
      remarkPlaceholder: "為此檔案加上簡短備註...",
      cancel: "取消",
      save: "儲存",
      saving: "儲存中..."
    }
