const en = {
  ...
  assetHub: {
    eyebrow: "Asset Hub",
    title: "Data Explorer",
    description: "Manage binary artifacts across your workspace and inspect file lineage metadata at a glance.",
    import: "Import File",
    importing: "Importing...",
    refresh: "Refresh",
    gridAriaLabel: "Asset file cards",
    emptyTitle: "No imported files yet",
    emptyDescription: "Click Import File to store a raw file in Blob Storage and publish it into the graph.",
    fileCard: {
      size: "Size",
      hash: "Hash",
    ...
    editModal: {
      ...
      remarkLabel: "Remark",
      remarkPlaceholder: "Add a short note about this file...",
      cancel: "Cancel",
      save: "Save",
      saving: "Saving..."
    }
  ...
  spreadsheet: {
    ...
    resizeHandle: "Drag to resize the spreadsheet",
    linked: "linked",
    demo: {
      time: "time",
      sensorA: "sensor_A",
