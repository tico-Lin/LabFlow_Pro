...
fn update_file_metadata(
    ...
    let mut properties: BTreeMap<String, String> = existing_node.properties.clone();
    ...
    let mut payload = NodePayload::new(existing_node.label.clone());
    payload.properties = properties;
    payload.content = existing_node.content.clone();
